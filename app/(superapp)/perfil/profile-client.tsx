            ...
            <Card className="bg-white dark:bg-slate-900 border-slate-100 dark:border-white/10 shadow-[0_1px_2px_rgba(0,0,0,0.04),_0_4px_8px_rgba(0,0,0,0.02)]">
                <CardHeader className="pb-4">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <CardTitle className="text-lg text-foreground dark:text-slate-50">{user.nome}</CardTitle>
                            <p className="text-sm text-muted-foreground dark:text-slate-400">{user.cargo || "Cargo não informado"}</p>
                        </div>
                    </div>
                </CardHeader>
                <CardContent className="space-y-4">
                    ...
                    <div className="flex items-center gap-3 text-sm text-foreground dark:text-slate-300">
                        ...
                        <span>{user.departamento || "Departamento não informado"}</span>
                    </div>
                </CardContent>
            </Card>
